...
<body class="bg-white text-gray-900">
    ...
    <header class="flex items-center justify-between px-4 py border-b border-gray-300">
        ...
        <form aria-label="Buscar eventos"
            class="flex items-center border border-gray-300 rounded-full px-3 py-1 max-w-xs w-full" role="search"
        ...
        <nav class="relative min-w-[160px]">
            <button aria-expanded="false" aria-haspopup="true"
                class="text-xs font-semibold text-gray-700 flex items-center space-x-1 focus:outline-none"
                id="comprasBtn">
                <span>COMPRAS & TICKETS</span>
                <i class="fas fa-chevron-down text-xs"></i>
            </button>
            <ul class="absolute left-1/2 -translate-x-1/2 mt-1 w-40 bg-white border border-gray-300 rounded shadow-md hidden z-10"
                id="comprasMenu" role="menu">
                <li><a href="{{ route('usuario.compras') }}"
                        class="block px-3 py-2 text-xs text-gray-700 hover:bg-gray-100" role="menuitem">MIS COMPRAS</a>
                </li>
                <li><a href="{{ route('usuario.etickets') }}"
                        class="block px-3 py-2 text-xs text-gray-700 hover:bg-gray-100" role="menuitem">E-TICKETS</a>
                </li>
                <li>
